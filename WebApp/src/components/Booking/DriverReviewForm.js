      ...
      <CollapsibleSection title={t('review.B. TỰ ĐÁNH GIÁ QCD')}>
        <div className="overflow-x-auto rounded-lg border border-gray-200">
          <table className="w-full table-fixed text-left border-collapse text-base">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-200">
                <th className="py-2 px-3 font-semibold text-gray-600 border-r border-gray-200 w-[35%]">{t('review.Đầu mục')}</th>
                <th className="py-2 px-3 font-semibold text-gray-600 text-center border-r border-gray-200 w-[6.66%]">Q</th>
                <th className="py-2 px-3 font-semibold text-gray-600 text-center border-r border-gray-200 w-[6.66%]">C</th>
                <th className="py-2 px-3 font-semibold text-gray-600 text-center border-r border-gray-200 w-[6.68%]">D</th>
                <th className="py-2 px-3 font-semibold text-gray-600 w-[45%]">{t('review.Ghi chú')}</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
                ...
                <tr key={item.key} className="hover:bg-gray-50/30 transition-colors">
                  ...
                  <td className="p-1 border-r border-gray-200">
                    <select
                      ...
                      onChange={(e) => handleQcdChange(item.key, 'q', e.target.value ? parseInt(e.target.value) : '')}
                      className="w-full border border-gray-300 rounded px-2 py-1 text-base bg-white focus:ring-blue-500 focus:border-blue-500 text-center"
                    >
                  ...
                  <td className="p-1 border-r border-gray-200">
                    <select
                      ...
                      onChange={(e) => handleQcdChange(item.key, 'c', e.target.value ? parseInt(e.target.value) : '')}
                      className="w-full border border-gray-300 rounded px-2 py-1 text-base bg-white focus:ring-blue-500 focus:border-blue-500 text-center"
                    >
                      <option value="">- / 5</option>
                      {[1, 2, 3, 4, 5].map((num) => (
                  ...
                  <td className="p-1 border-r border-gray-200">
                    <select
                      ...
                      onChange={(e) => handleQcdChange(item.key, 'd', e.target.value ? parseInt(e.target.value) : '')}
                      className="w-full border border-gray-300 rounded px-2 py-1 text-base bg-white focus:ring-blue-500 focus:border-blue-500 text-center"
                    >
                      <option value="">- / 5</option>
                      {[1, 2, 3, 4, 5].map((num) => (
