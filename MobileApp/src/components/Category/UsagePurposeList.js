...
function UsagePurposeList({
  ...
  const filterFields = [
    ...
    { name: 'mkey', placeholder: t('usagePurpose.Mã mục đích sử dụng') },
    { name: 'mvalue', placeholder: t('usagePurpose.Tên mục đích sử dụng') }
  ];

  const requestFields = [
    { name: 'id', label: t('usagePurpose.ID'), render: (field, request) => request[field] },
    { name: 'mkey', label: t('usagePurpose.Mã mục đích sử dụng'), render: (field, request) => request[field] },
    { name: 'mvalue', label: t('usagePurpose.Tên mục đích sử dụng'), render: (field, request) => request[field] }
  ];
